...
import config
from core.decision_resolver import (
    LEFT_DIRECTION,
    LEFT_OPTION,
    RIGHT_DIRECTION,
    RIGHT_OPTION,
...
from core.effects import get_death_info, get_end_stat
from core.event_manager import EventManager
from core.game_session import GameSession
from core.settings_state import SettingsState
...
class GameApp:
    def __init__(self):
        ...
        from screens.intro_screen import show_intro_card
    ...
    def _handle_game_input(self, event, swipe_direction):
        from core.sounds import page_sound
