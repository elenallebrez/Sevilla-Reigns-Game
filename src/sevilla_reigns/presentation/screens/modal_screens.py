...
def show_final_screen(screen, death_text: str, background_image: str | None):
    from sevilla_reigns.infrastructure.audio.sounds import reproducir_muerte, reproducir_musica
...
def show_exit_confirmation(screen):
    from sevilla_reigns.infrastructure.audio.sounds import click_sound
